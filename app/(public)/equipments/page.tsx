...
import { EQUIPMENT_LISTINGS, EquipmentItem, filterEquipment } from "@/lib/data/equipment"
...
export default function EquipmentsPage() {
  ...
  // Filter listings
  const filteredListings = filterEquipment(EQUIPMENT_LISTINGS, searchQuery, selectedCategory, selectedType)
